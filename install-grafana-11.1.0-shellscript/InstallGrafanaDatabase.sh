...
#---------------------------------------------------------#
# Script name: Install Grafana database                   #
# Description: Install and configure MariaDB for Grafana  #
...
# Use: ./InstallGrafanaDatabase.sh                        #
#---------------------------------------------------------#

echo ' '
echo '#####################################################################################'
echo '## This script will install and configure MariaDB for Grafana.                     ##'
echo '#####################################################################################'
echo ' '
...
while true; do
   ...
   echo '## - Set root and grafana passwords in the "variables-db" file;                    ##'
   echo '## - Set the IP adress for remote access in the "variables-db" file.               ##'
   echo '##                                                                                 ##'
   echo '## Did you set root and grafana passwords and the IP address for remote access?    ##'
...
elif [ "$DISTRO" = 'Fedora Linux 40' ]; then
   echo "Your distribution is $DISTRO"
   echo -e 'Continuing...\n'
   sleep 2
